import { Company, PolicyVariantType } from "@repo/database";
...
export function getSystemPrompt(variantType: PolicyVariantType): string {
  ...
  switch (variantType) {
    case PolicyVariantType.EXECUTIVE_SUMMARY:
    ...
    case PolicyVariantType.COMPREHENSIVE_POLICY:
    ...
    case PolicyVariantType.VENDOR_REQUIREMENTS:
    ...
    case PolicyVariantType.CODING_STANDARDS:
